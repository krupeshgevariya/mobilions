...
//blog detail page count total views
...
function gt_set_post_view()
{
    ...
    if (count($_COOKIE)) {
        $count = 0;
        setcookie("identixweb_blog_post_count", $count, time() + 60 * 60 * 24, "/");
...
function blog_list_shortcode(){
    ...
    <script>
        ...
        $('.pagination a').click( function () {
            ...
            $('.blog-col').addClass('loader');
            $.ajax({
                url: '<?php admin_url('admin-ajax.php'); ?>',
                type: 'get',
                success: function (data) {
                    var content = $(data).find('.tabcontent').html();
                    $('.blog-col').removeClass('loader');
        ...
        <div class="blog-main-page banner-title-bg">
            <div class="wrap">
                <div class="hero-heading">
                    <h1>Blog</h1>
                    <p>Gather knowledge about the latest insights, updates, tips, and tricks in the eCommerce industry.</p>
                </div>
            </div>
        </div>
    </section> -->
...
add_shortcode('blog_list_shortcode', 'blog_list_shortcode');